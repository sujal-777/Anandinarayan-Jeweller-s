...
const pgData = [
  {
    ...
    text2:
      "Swimming engages all the major muscle groups in your body, making it an excellent way to tone muscles and improve overall strength. Whether you're doing laps or water aerobics, you'll be giving your body a complete workout.",
