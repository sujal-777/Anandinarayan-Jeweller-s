        ...
        <section>
            ...
            >
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                    ...
                    <p className="text-xl text-white">COMMITMENT TOWARDS HONOURABLE & SUSTAINABLE TOURISM</p>
                    <br /> <br />
                    ...
                    <form className="mt-8 flex justify-center space-x-4">
                        ...
                        <input
                            ...
                            className="py-2 px-4 bg-white border border-gray-300 rounded-md"
                        />
                        <button className="py-2 px-6 bg-[#AA8453] text-white rounded-md">Check Now</button>
                    </form>
                </div>
            </div>
