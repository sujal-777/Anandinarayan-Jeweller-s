...
const contentfaq = [
  ...
  },
  {
    ...
    answer:
      "If your travel plans change or delay, you can cancel or modify your reservation in accordance with the hotel's cancellation policy as stated during the reservation process.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "For discount codes on Hotel Ashok's website, you can check their official website, we often have special offers or codes available for booking directly through our website.",
  },
];
            ...
            <AccordionItem
              ...
              indicator={({ isOpen }) =>
                isOpen ? (
                  ...
                  <PlusIcon width="18" height="18" className="text-[#AA8453]" />
                )
              }
              title={item.question}
