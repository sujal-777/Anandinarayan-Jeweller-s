...
export default function Weddings() {
  return (
    <section>
      <p className="text-4xl font-gilda text-black flex justify-center items-center mt-20">
        Weddings
      </p>
      ...
      <div className="w-full flex flex-col justify-center items-center">
        <div className="flex flex-col sm:flex-row justify-center items-start">
          <div className="w-full sm:w-1/2 flex flex-col justify-center p-20 text-justify">
            ...
            <p className="text-black font-gilda mt-5">
              The hotel is committed to delivering fresh food, avoiding the use
              of cold storage to ensure quality and freshness.
            </p>
          </div>
      ...
      <div className="w-full flex flex-col justify-center items-center">
        <div className="flex flex-col sm:flex-row justify-center items-start">
          ...
          <div className="w-full sm:w-1/2 flex flex-col justify-center p-20 text-justify">
            ...
            <p className="text-2xl text-black font-gilda mt-5">
