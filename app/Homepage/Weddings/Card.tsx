    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            >
                ...
                <p className="leading-loose font-barlow" data-aos="fade-up">
                ...
                <Link href={link} className="block w-fit bg-[#AB8A62] p-2 font-barlow text-lg text-white uppercase" data-aos="fade-up">
                    Learn More
                </Link>
            </div>
        </div>
