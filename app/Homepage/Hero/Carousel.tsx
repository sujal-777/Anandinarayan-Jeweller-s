                        ...
                        >
                            <div className="relative flex h-full w-full flex-col items-center justify-center gap-4 px-8 py-20 text-center text-white lg:px-96">
                                ...
                                >
                                    ...
                                    <h1 className=" text-3xl md:text-heading font-[500] uppercase tracking-wider font-gilda">
                                        {item.title1}
                                    </h1>
                                </div>
                                {item.btnTitle !== "" && (
                                ...
                                />
                                <div className="absolute left-0 top-0 z-20 h-full w-full bg-black bg-opacity-60"></div>
                            </div>
                        </div>
                    ))}
                </div>
