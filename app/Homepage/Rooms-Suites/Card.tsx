    ...
    return (
        <div className="group relative aspect-video w-full overflow-clip" data-aos="fade-in">
            ...
            href={"https://www.swiftbook.io/inst/#home?propertyId=963MTUJmY1lpZeCmz9rXlfH7YmoaIvdJKdXK4LhxJkZp0tg0ZSH9q9wNA==&JDRN=Y"}
                className={`absolute right-0 top-[10%] z-30 -rotate-90 border-2 border-white p-2 font-barlow text-[0.5rem] md:text-sm uppercase tracking-wider text-white md:top-[15%] hover:bg-white hover:text-black trans-duration-500`}
            >
                Book Now
            </Link>
