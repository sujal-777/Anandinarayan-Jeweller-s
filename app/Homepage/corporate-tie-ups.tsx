        ...
        <div className="flex flex-col sm:flex-row justify-center items-start">
          <div className="w-full sm:w-1/2 flex flex-col justify-center p-20 text-justify">
            ...
            <p className="text-black font-gilda">
              Hotel Ashok offers premium corporate tie-up services, providing
              bespoke accommodation solutions tailored to the unique needs of
              businesses.{" "}
            </p>

            <p className="text-black font-gilda">
              With state-of-the-art facilities and personalized service, our
              corporate partnerships ensure a seamless and productive stay for
              your team. Elevate your business trips with the unmatched
              hospitality of Hotel Ashok.{" "}
            </p>
            ...
            <div className="flex items-center">
              ...
              <div className="flex flex-col">
                <p className="text-lg text-black">For information</p>
