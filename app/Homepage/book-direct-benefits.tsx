...
const Card: React.FC<CardProps> = ({ title, description }) => (
  <div className="p-10">
    <div className="text-black font-gilda relative flex flex-col justify-start items-start min-h-full p-5">
...
export default function BookDirectBenefits() {
  ...
  return (
    <section className="bg-[#222222]">
      <p className="text-4xl font-gilda text-white flex justify-center items-center p-20">
