            ...
            {roomArray.map((item, index) => (
                <div key={index} className="relative flex w-full">
                    <div className="flex w-1/2 items-center justify-center ">
                        <Card
                            radius="none"
                            className="w-3/4 border-2 border-blue-400 px-5"
                        >
                                ...
                                <div className=" flex items-center justify-center">
                                    <div className="grid grid-cols-3 gap-4">
                                        <p className="mt-2 flex items-center">
                                            <PersonIcon className="mr-2" /> 1-2
                                            Persons
                                        </p>
                                        <p className="mt-2 flex items-center">
                                            <WifiIcon className="mr-2" /> Free
                                            WiFi
                                        </p>
                                        <p className="mt-2 flex items-center">
                                            <BedIcon className="mr-2" /> Twin
                                            Bed
                                        </p>
                                        <p className="mt-2 flex items-center">
                                        ...
                                        <p className="mt-2 flex items-center">
                                            <ClockIcon className="mr-2" /> 200
                                            sqft room
                                        </p>
                                        <p className="mt-2 flex items-center">
                                            <SwimmingPool className="mr-2" />{" "}
                                            Swimming Pool
                                        </p>
                                    </div>
                                </div>
